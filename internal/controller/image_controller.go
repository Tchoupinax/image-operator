...
// +kubebuilder:rbac:groups=tchoupinax.dev,resources=images,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=tchoupinax.dev,resources=images/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=tchoupinax.dev,resources=images/finalizers,verbs=update

// +kubebuilder:rbac:groups=batch,resources=jobs,verbs=get;list;create;watch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;create;watch
