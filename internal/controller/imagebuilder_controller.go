...
// +kubebuilder:rbac:groups=tchoupinax.dev,resources=imagebuilders,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=tchoupinax.dev,resources=imagebuilders/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=tchoupinax.dev,resources=imagebuilders/finalizers,verbs=update
...
func (r *ImageBuilderReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&tchoupinaxiov1beta.ImageBuilder{}).
		Named("imagebuilder").
		Complete(r)
}
